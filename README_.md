...
***Start recording***
```bash
ros2 service call /recorder_controller/record_mode addverb_cobot_msgs/srv/Record "{enable: true,label: "test_left",rate: 15}"
```
***Stop recording***
```bash
ros2 service call /recorder_controller/record_mode addverb_cobot_msgs/srv/Record "{enable: false,label: "test_left",rate: 15}"
```
***Replay recording***
```bash
ros2 action send_goal /recorder_controller/replay_mode addverb_cobot_msgs/action/Replay "{label : "test_left", iterations: 3}"
```
### Gripper Service
